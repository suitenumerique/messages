...
def fixture_test_threads(test_mailboxes, wait_for_indexing):
    ...
    thread2 = ThreadFactory(mailbox=mailbox1, subject="Team Update")
    ...
    thread3 = ThreadFactory(mailbox=mailbox1, subject="Draft Report")
    ...
    thread4 = ThreadFactory(mailbox=mailbox1, subject="Old Newsletter")
    ...
    thread5 = ThreadFactory(mailbox=mailbox1, subject="Important Announcement")
    ...
    thread6 = ThreadFactory(mailbox=mailbox1, subject="New Notification")
    ...
    thread7 = ThreadFactory(mailbox=mailbox1, subject="Project Feedback")
    ...
    thread8 = ThreadFactory(mailbox=mailbox2, subject="Different Mailbox Message")
    ...
    thread9 = ThreadFactory(mailbox=mailbox1, subject="Sent Message")
