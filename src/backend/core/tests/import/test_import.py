...
def eml_file():
    ...
    with open("core/tests/import/data/message.eml", "rb") as f:
        return f.read()
...
def mbox_file():
    ...
    with open("core/tests/import/data/messages.mbox", "rb") as f:
        return f.read()
...
def test_import_eml_file(admin_client, eml_file, mailbox):
    ...
    eml_file = SimpleUploadedFile(
        "test.eml", eml_file, content_type="message/rfc822"
    )
