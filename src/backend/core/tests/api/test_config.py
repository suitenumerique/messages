...
@override_settings(
    ...
    MAX_DEFAULT_RECIPIENTS_PER_MESSAGE=200,
)
...
def test_api_config(is_authenticated):
    ...
    assert response.json() == {
        ...
        "MAX_RECIPIENTS_PER_MESSAGE": 200,
        "MAX_DEFAULT_RECIPIENTS_PER_MESSAGE": 200,
        "MAX_RECIPIENTS_FOR_DOMAIN": "1500/d",
        "MAX_DEFAULT_RECIPIENTS_FOR_DOMAIN": "1000/d",
        "MAX_RECIPIENTS_FOR_MAILBOX": "500/d",
        "MAX_DEFAULT_RECIPIENTS_FOR_MAILBOX": "100/d",
    }
