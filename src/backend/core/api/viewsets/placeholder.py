...
class DraftPlaceholderView(APIView):
    ...
    @extend_schema(
        ...
        responses={
            ...
            403: {"description": "User does not have editor access to this draft"},
    ...
    def get(self, request, message_id):
        ...
        try:
            message = models.Message.objects.select_related("sender__mailbox").get(
                id=message_id,
                is_draft=True,
                thread__accesses__mailbox__accesses__user=request.user,
                thread__accesses__mailbox__accesses__role__in=enums.MAILBOX_ROLES_CAN_EDIT,
