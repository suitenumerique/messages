# Generated by Django 5.1.12 on 2025-09-22 22:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'constraints': [models.CheckConstraint(condition=models.Q(('mailbox__isnull', False), ('maildomain__isnull', False), _connector='XOR'), name='channel_has_target')],
            },
        ),
    ]
