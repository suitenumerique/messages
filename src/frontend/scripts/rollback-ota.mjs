...
//
// On a Scalingo-driven channel the nominal rollback is to redeploy the old
// commit, which re-flips the manifest the same way while keeping mobile and web
// in step (see docs/mobile-release.md, "Publishing from Scalingo deploys");
// this script is the dev/emergency path.
//
