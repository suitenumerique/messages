            ...
            <div className="search__container">
                <div className="search__input-container">
                    ...
                    <input
                        ...
                        // On touch the field is read-only and the tap opens
                        // the modal; opening on focus too would reopen it
                        // as soon as the closing modal hands the focus back.
                        onFocus={isMobile ? undefined : () => setShowFilters(true)}
