...
type MobileToolbarButtonProps = {
    ...
    /** For a button opening a popover: whether it is currently open. */
    isExpanded?: boolean;
};
...
export const MobileToolbarButton = ({
    ...
    <button
        ...
        aria-label={label}
        // A popover trigger is expanded or not; a toggle is pressed or not.
        // The two are exclusive: a button announced as both is confusing.
        aria-pressed={isExpanded === undefined ? isActive : undefined}
