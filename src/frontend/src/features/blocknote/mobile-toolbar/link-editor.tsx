...
export const MobileLinkEditor = ({ onClose }: { onClose: () => void }) => {
    ...
    return (
        <div
            className="mobile-toolbar__link-editor"
            role="group"
            aria-label={editor.dictionary.formatting_toolbar.link.tooltip}
        >
            <MobileToolbarButton
            ...
            <input
                ...
                // A placeholder is not a name: it vanishes as soon as the
                // user types, and not every screen reader falls back on it.
