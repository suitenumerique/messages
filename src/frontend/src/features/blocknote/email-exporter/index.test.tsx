...
describe('EmailExporter', () => {
  ...
  describe('section wrapper', () => {
    it('wraps output in a table with role="presentation"', () => {
      const html = exportBlocks([paragraph('Hello')]);
  ...
  describe('special blocks', () => {
    ...
    it('does not render unknown block without content', () => {
      ...
      // Should not produce any visible element besides the section wrapper
  ...
  describe('golden snapshots', () => {
    it('renders a paragraph with styled text', () => {
      ...
      expect(html).toMatchInlineSnapshot(`"<table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation"><tbody><tr><td><p style="font-size:14px;line-height:24px;margin:0;margin-top:0;margin-bottom:0;margin-left:0;margin-right:0">Hello <span style="font-weight:bold">world</span></p></td></tr></tbody></table>"`);
    });
    ...
    it('renders a heading with block-level color', () => {
      ...
      expect(html).toMatchInlineSnapshot(`"<table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation"><tbody><tr><td><h2 style="color:#e03e3e">Important</h2></td></tr></tbody></table>"`);
    });
    ...
    it('renders an image with caption and center alignment', () => {
      ...
      expect(html).toMatchInlineSnapshot(`"<link rel="preload" as="image" href="https://example.com/photo.jpg"/><table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation"><tbody><tr><td><figure style="margin:0;text-align:center"><img alt="A nice photo" src="https://example.com/photo.jpg" style="display:block;outline:none;border:none;text-decoration:none;margin-left:auto;margin-right:auto" width="400"/><figcaption>A nice photo</figcaption></figure></td></tr></tbody></table>"`);
    });
  });
});
