...
export const getMaildomainsMessageTemplatesListUrl = (maildomainPk: string) => {
...
export const maildomainsMessageTemplatesList = async (
  ...
  return fetchAPI<maildomainsMessageTemplatesListResponse>(
    getMaildomainsMessageTemplatesListUrl(maildomainPk),
    {
      ...options,
      method: "GET",
    },
...
export const getMaildomainsMessageTemplatesListQueryKey = (
  ...
  return [`/api/v1.0/maildomains/${maildomainPk}/message-templates/`] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getMaildomainsMessageTemplatesListQueryKey(maildomainPk);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof maildomainsMessageTemplatesList>>
  > = ({ signal }) =>
    maildomainsMessageTemplatesList(maildomainPk, {
      signal,
      ...requestOptions,
    });
