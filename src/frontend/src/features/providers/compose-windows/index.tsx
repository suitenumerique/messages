...
export const ComposeWindowsProvider = ({ children }: PropsWithChildren) => {
    ...
    // A tab leaving inside the debounce still flushes, or a window closed
    // right before a reload would come back.
    useEffect(() => {
    ...
    // Other tabs edit drafts this tab cannot see changing (queries do not
    // refetch on focus): refresh the affected caches on their broadcasts, and
