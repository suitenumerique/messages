...
export const ComposeWindowsLayer = () => {
    ...
    const [prevActiveWindowId, setPrevActiveWindowId] = useState(activeWindow?.windowId);
    const [stackTakesFocus, setStackTakesFocus] = useState(false);
    if (prevActiveWindowId !== activeWindow?.windowId) {
        setPrevActiveWindowId(activeWindow?.windowId);
        setStackTakesFocus(prevActiveWindowId !== undefined && activeWindow === undefined);
    }
