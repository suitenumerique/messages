import { MailDomainAdmin, MessageTemplateKindChoices, ReadOnlyMessageTemplate, useMessageTemplatesCreate, useMessageTemplatesUpdate } from "@/features/api/gen";
...
import { RhfTextArea } from "@/features/forms/components/react-hook-form/rhf-textarea";
    ...
    return (
        <FormProvider {...form}>
            <form className="signature-composer-form" onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <div className="form-field-row">
                    <RhfTextArea
                        label={t('admin_maildomains_signature.compose_modal.form.labels.description')}
                        name="description"
                        rows={2}
                        fullWidth
                    />
                ...
                <div className="form-field-row">
                    <SignatureComposer
                        defaultValue={defaultValue?.raw_blob}
                ...
                <div className="form-field-row">
                    ...
                    />
                    <RhfCheckbox
                        label={t('admin_maildomains_signature.compose_modal.form.labels.is_default')}
                        name="is_default"
                        text={t('admin_maildomains_signature.compose_modal.form.helper_text.is_default')}
                        fullWidth
                    />
                </div>
