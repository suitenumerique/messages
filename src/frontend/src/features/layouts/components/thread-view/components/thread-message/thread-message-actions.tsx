...
const ThreadMessageActions = ({
    ...
    const dropdownOptions = [
        ...
        // No printing in the native shell: `window.open('')` + `print()` has no
        // print pipeline in WKWebView / the Android WebView without a native
        // plugin (UIPrintInteractionController / PrintManager), which an OTA
        // bundle cannot ship.
        ...(!isNativePlatform() ? [{
            label: t('Print'),
