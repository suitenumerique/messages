...
import { IconType, Spinner, useResponsive } from "@gouvfr-lasuite/ui-components";
    ...
    ({ message, isLatest, draftMessage, ...props }, ref) => {
        ...
        return (
            ...
            >
                ...
                {isMessageReady && (detachedWindow || forcePlaceholder || showReplyForm) && (
                    <div className="thread-message__reply-slot">
