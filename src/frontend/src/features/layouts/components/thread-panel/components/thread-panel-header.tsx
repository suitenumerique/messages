        ...
        <div className={clsx("thread-panel__bar", {
            ...
            <DropdownMenu
                ...
                options={[
                    ...
                    ...([SelectionReadStatus.MIXED].includes(selectionReadStatus) ? [{
                    ...
                    ...([SelectionReadStatus.MIXED, SelectionReadStatus.NONE].includes(selectionReadStatus) ? [{
        ...
        <>
            ...
            <div className={clsx("thread-panel__header--details", {
                ...
                {showSelectionBar ? (
                    ...
                    <>
                        {selectAllCheckbox}
                        {/* Live: the pull-to-refresh result and the loading
                            state replace the count here, and nothing else
                            announces them on touch (the indicator is
                            decorative). Polite and atomic: the whole line
                            is read once, never over what is being read. */}
                        <p
                            className="thread-panel__header--count"
                            title={detailsTitle}
                            role="status"
                            aria-live="polite"
                            aria-atomic="true"
            ...
            {hasFloatingActions ? (
                ...
                <div className={clsx("thread-panel__header--columns", {
                    ...
                    <div className="thread-panel__header--text">
                        {/* The native selection drops the title row: the
                            selected count is already the bar's job there. */}
                        {isNative && isSelectionMode ? headerSelection : headerText}
                    </div>
                    {actionsBar}
                </div>
            ) : headerText}
