...
import { ModalDrawer } from "@/features/ui/components/drawer";
...
export const LabelsPopup = ({
    ...
    useEffect(() => {
        // The mobile drawer is a dialog of its own: it handles Escape itself,
        // with its exit animation.
        if (isMobile) return;
    ...
    if (isMobile) {
        return (
            <ModalDrawer
                title={t('Add labels')}
                onClose={onClose}
                overlayClassName="labels-widget__drawer"
            >
